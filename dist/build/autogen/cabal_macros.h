...
/* package test-hask-0.1.0.0 */
#define VERSION_test_hask "0.1.0.0"
#define MIN_VERSION_test_hask(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "test-hask-0.1.0.0"

#define CURRENT_PACKAGE_KEY "test-hask-0.1.0.0"
